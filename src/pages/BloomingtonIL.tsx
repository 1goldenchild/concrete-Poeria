...
const BloomingtonIL = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Concrete Contractors - Stamped Company - Bloomington, IL</title>
        <meta 
          name="description" 
          content="Expert concrete contractors in Bloomington! Our concrete company creates beautiful driveways, patios, and stamped concrete. Call 309-245-7421 today!" 
        />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-4">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Bloomington, IL</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            <div className="lg:w-1/2">
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
                <Link to="/" className="hover:text-primary/90">Concrete Company</Link> and Concrete Contractors in Bloomington, IL
              </h1>
              <p className="text-lg mb-8">
                From beautiful <Link to="/stamped-concrete-peoria-il" className="text-primary hover:underline">stamped concrete</Link> designs to durable <Link to="/concrete-driveway-peoria-il" className="text-primary hover:underline">concrete driveways</Link>, our Bloomington team delivers quality concrete solutions for residential and commercial properties.
              </p>
            ...
            <div className="lg:w-1/2">
              <img 
                ...
                alt="Professional concrete contractors pouring a new concrete driveway in Bloomington, IL" 
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              <p className="text-lg mb-6">
                Bloomington, IL is home to many exceptional <Link to="/" className="text-primary hover:underline">concrete contractors</Link>. Peoria Concrete Co., your local concrete company, is dedicated to completing any project you need around your home.
              </p>
              <p className="text-lg mb-6">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="md:w-1/2">
                <img 
                  ...
                  alt="Freshly poured concrete patio with decorative finish in Bloomington, Illinois" 
            ...
            <div>
              ...
              <p className="text-lg mb-6">
                We at Peoria Concrete Co. are dedicated to providing the best concrete contracting services to the residents of Bloomington, Illinois, and the surrounding areas. Our team of local concrete builders can handle all of your concrete designs, whether they are for homes or businesses. From roads and walkways to concrete flatwork, we provide a variety of projects.
              </p>
              <p className="text-lg mb-6">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-4">Bloomington, Illinois Concrete Services</h3>
              <p className="text-lg mb-6">Our comprehensive services include:</p>
              ...
              <p className="text-lg mb-6">
                While we specialize in concrete services, we're also highly skilled patio contractors and deck builders. You can count on our team for any concrete project!
              </p>
            </div>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div className="md:w-1/2">
                  <img 
                    ...
                    alt="Beautiful stamped concrete patio design in Bloomington with decorative patterns" 
                    className="rounded-lg shadow-md w-full h-auto"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <p className="text-lg mb-6">
                We can take care of any type of concrete service you want in Bloomington, IL, whether it be for a business or a residence, as quickly as feasible.
              </p>
            </div>
            ...
            <div className="sticky top-8 space-y-6">
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium">Bloomington, IL Service Area</span>
                    </div>
              ...
              <Card className="shadow-lg overflow-hidden">
                <img 
                  ...
                  alt="Concrete contractors working on a stamped concrete project in Bloomington, Illinois" 
      ...
      <section className="bg-gradient-to-r from-primary to-blue-700 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Call us today for your free estimate</h2>
          <p className="text-xl mb-6 max-w-2xl mx-auto">
            Our concrete experts are ready to help with your project in Bloomington, IL
          </p>
          <Button 
            size="lg" 
            variant="outline" 
      ...
      <section className="py-12 container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-6 text-center">Our Service Area in Bloomington, IL</h2>
        <div className="w-full rounded-lg overflow-hidden shadow-xl">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d96879.79242694178!2d-89.02544466250014!3d40.48439847080449!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880a37399579ca63%3A0xbea9b92859219462!2sBloomington%2C%20IL%2C%20USA!5e0!3m2!1sen!2sma!4v1743013484939!5m2!1sen!2sma" 
            width="100%" 
            height="450" 
            style={{ border: 0 }} 
            allowFullScreen 
