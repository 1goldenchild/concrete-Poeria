...
const ChampaignIL = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Concrete Contractors | Concrete Company | Champaign | IL</title>
        <meta
          name="description"
          content="Need a concrete company in champaign? Our dedicated concrete contractors provide reliable foundations, slabs, and more. Call 309-245-7421 now!"
        />
      </Helmet>
      ...
      <div className="container px-4 py-8 mx-auto max-w-7xl">
        ...
        <div className="relative rounded-xl overflow-hidden mb-12">
          ...
          />
          <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-start px-8 md:px-16 z-20">
            <div className="max-w-2xl">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Champaign, IL Concrete Company and Concrete Builders
              </h1>
              <Button 
                onClick={handleCallClick} 
                size="lg" 
                className="bg-accent hover:bg-accent/90 text-white gap-2 text-lg"
              >
                <Phone className="h-5 w-5" /> Call Us Now: 309-245-7421
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <div className="prose max-w-none">
              <p className="text-lg">
                We can do a number of different types of concrete work in or near your home here in Champaign. You've come to the right place if you want to add more concrete to your home. In Champaign, there are a lot of great concrete businesses. For any work you need done around your house, Peoria Concrete Co. is the concrete company in your area that can do it.
              </p>
              <p className="text-lg">
